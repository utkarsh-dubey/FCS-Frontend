...
const AllUser = () => {
  ...
  const handleClose = () => setOpen(false);
    useEffect(()=>{
      const userId = localStorage.getItem("userId");
        axios.get(`/user/get/users/${userId}`,{headers: { Authorization: `Bearer ${localStorage.getItem("auth_token")}`}}).then(res=>setMainData(res.data));
    }, [])
  ...
  const handleUser = (id) => {
    const userId = localStorage.getItem("userId");
      axios.post(`/admin/banuser/${userId}?user=${id}`)
  }
