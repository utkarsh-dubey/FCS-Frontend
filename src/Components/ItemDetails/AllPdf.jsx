...
const AllPdf = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`/pdf/all/${userId}`,{headers: { Authorization: `Bearer ${localStorage.getItem("auth_token")}`}}).then((res) => {
  ...
  const handleApprove = (id) => {
    const userId = localStorage.getItem("userId");
    axios
      .post(`/admin/approve/${userId}?pdfId=${id}`,{},{headers: { Authorization: `Bearer ${localStorage.getItem("auth_token")}`}})
      .then((res) => {
        // console.log(res.data);
      });
  };
  const handleReject = (id) => {
    const userId = localStorage.getItem("userId");
    axios
      .post(`/admin/reject/${userId}?pdfId=${id}`,{headers: { Authorization: `Bearer ${localStorage.getItem("auth_token")}`}})
      .then((res) => {
        // console.log(res.data);
      });
  };
