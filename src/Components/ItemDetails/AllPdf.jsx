...
const AllPdf = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`http://18.205.236.51:7000/pdf/all/${userId}`,{headers: { Authorization: `Bearer ${localStorage.getItem("auth_token")}`}}).then((res) => {
  ...
  const handleApprove = (id) => {
    const userId = localStorage.getItem("userId");
    axios
      .post(`http://18.205.236.51:7000/admin/approve/${userId}?pdfId=${id}`,{},{headers: { Authorization: `Bearer ${localStorage.getItem("auth_token")}`}})
      .then((res) => {
        console.log(res.data);
      });
  };
  const handleReject = (id) => {
    const userId = localStorage.getItem("userId");
    axios
      .post(`http://18.205.236.51:7000/admin/reject/${userId}?pdfId=${id}`,{headers: { Authorization: `Bearer ${localStorage.getItem("auth_token")}`}})
      .then((res) => {
        console.log(res.data);
      });
  };
