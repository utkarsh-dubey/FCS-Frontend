...
const AllProduct = () => {
  ...
  const handleClose = () => setOpen(false);
    useEffect(()=>{
        axios.get(`https://54.85.12.94:7000/product`).then(res=>{setMainData(res.data)});
    }, [])
  ...
  const handleUser = (id) => {
    const userId = localStorage.getItem("userId");
      axios.post(`https://54.85.12.94:7000/admin/banproduct/${userId}?product=${id}`,{},{headers: { Authorization: `Bearer ${localStorage.getItem("auth_token")}`}})
  }
