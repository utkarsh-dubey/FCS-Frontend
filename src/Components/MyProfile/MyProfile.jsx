...
const MyProfile = () => {
    ...
    const handleSave = () => {
        const userId = localStorage.getItem("userId");
          ...
          axios.post(`http://54.85.12.94:7000/user/update/${userId}`, payload,{headers: { Authorization: `Bearer ${localStorage.getItem("auth_token")}`}}).then(res=>console.log(res.data));
      }
