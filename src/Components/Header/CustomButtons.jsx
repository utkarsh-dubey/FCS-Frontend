...
//   const { cartItems } = cartDetails;
  useEffect(() => {
    ...
    axios
      .get(`http://54.85.12.94:7000/user/user/${userId}`,{headers: { Authorization: `Bearer ${localStorage.getItem("auth_token")}`}})
  ...
  const handleSubmit = () => {
    const userId = localStorage.getItem("userId");
      ...
      axios.post(`http://54.85.12.94:7000/user/become/seller/${userId}`, payload,{headers: { Authorization: `Bearer ${localStorage.getItem("auth_token")}`}}).then(res=>console.log(res.data));
      handleClose();
  }
