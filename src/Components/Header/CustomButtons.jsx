...
//   const { cartItems } = cartDetails;
  ...
  const handleSubmit = () => {
    const userId = localStorage.getItem("userId");
      ...
      axios.post(`https://54.85.12.94:7000/user/become/seller/${userId}`, payload,{headers: { Authorization: `Bearer ${localStorage.getItem("auth_token")}`}}).then(res=>console.log(res.data));
      handleClose();
  }
